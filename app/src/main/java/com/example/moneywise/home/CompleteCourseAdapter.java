...
import com.example.moneywise.quiz.activity_individual_course_joined;
...
public class CompleteCourseAdapter extends RecyclerView.Adapter<CompleteCourseAdapter.completeCourseViewHolder>{
    List<Course> courseList;
    FirebaseStorage storage;
    Context context;
    public CompleteCourseAdapter(Context context, List<Course> courseList) {
    ...
    @NonNull
    @Override
    public CompleteCourseAdapter.completeCourseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        View view = LayoutInflater.from(context).inflate(R.layout.single_complete_course_display, parent, false);
        return new CompleteCourseAdapter.completeCourseViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CompleteCourseAdapter.completeCourseViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class completeCourseViewHolder extends RecyclerView.ViewHolder {
        ImageView imageViewCourseCover;
        TextView textViewCourseTitle;

        public completeCourseViewHolder(@NonNull View itemView) {
            super(itemView);
