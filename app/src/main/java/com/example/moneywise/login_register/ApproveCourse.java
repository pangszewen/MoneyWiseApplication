...
import com.example.moneywise.quiz.fragment_course_desc;
...
public class ApproveCourse extends AppCompatActivity {
    ...
    private void saveRejectStatusToDatabase() {
        ...
        courseRef.delete()
                .addOnSuccessListener(aVoid -> {
                    ...
                    Intent intent = new Intent(ApproveCourse.this, CoursePendingDisplay.class);
    ...
    public void backToPreviousActivity(){
        Intent intent = new Intent(ApproveCourse.this, activity_complete_continue_course.class);
